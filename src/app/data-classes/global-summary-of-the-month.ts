...
export interface GlobalSummaryOfTheMonthObservation extends StationObservation {
  DATE: string;
  ELEVATION: number;
  LATITUDE: number;
  LONGITUDE: number;
...
export const GlobalSummaryOfTheMonthDataTypes: DataType[] = [
  {
    id: 'WSFM',
    datasetId: 'global-summary-of-the-month',
  ...
  },
  {
    id: 'DP10',
    datasetId: 'global-summary-of-the-month',
    name: 'Number days with greater than 0.10 inch (2.54mm) of precipitation',
    selected: false,
    metricUnits: '',
    standardUnits: '',
    metricColumnDef: {
  ...
  },
  {
    id: 'DP01',
    datasetId: 'global-summary-of-the-month',
    name: 'Number days with greater than 0.01 inch (0.25mm) of precipitation',
    selected: false,
    metricUnits: '',
    standardUnits: '',
    metricColumnDef: {
